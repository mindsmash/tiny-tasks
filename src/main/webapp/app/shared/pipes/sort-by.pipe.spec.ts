...
describe('SortByPipe', () => {
  ...
  const array: Task[] = [
    ...
    { id: '0c4849a6-c4be-4e73-a046-62bab45cd885', name: 'Walk the dog 4' } as Task,
    { id: '3d4218ce-6d42-4326-a971-8cab84c71336', name: 'Walk the dog 5' } as Task,
  ];
  ...
  it('should sort the array by date', () => {
    ...
    expect(sortedArray[sortedArray.length - 1].dueDate).toEqual(undefined);
  });
  ...
  it('should sort the array by date after inserting a task', () => {
    ...
    expect(newArray[newArray.length - 1].dueDate).toEqual(undefined);
  });
});
