...
describe('LocalTaskService', () => {
  ...
  const mockTask2: Task = {id: id, name: name, done: done};
  ...
  it('should update task to done to local storage', () => {
    // when
    taskService.update(id, mockTask2);
  ...
  it('should delete tasks from local storage', () => {
    // when
