...
describe('DefaultTaskService', () => {
  ...
  it('should post task', () => {
    ...
    const req = httpTestingController.expectOne(
      request => request.url === 'http://backend.tld/tasks'
    )
  ...
  it('should delete task', () => {
    ...
    // then
    const req = httpTestingController.expectOne(
      request => request.url === 'http://backend.tld/tasks/id123'
    )
  ...
  it('should change the status to done, by clicking', () => {
    // when
    taskService.setIsDone('done').subscribe()
  ...
  it('should delete all done taks', () => {
    // when
    taskService.deleteDoneTasks('id123').subscribe()
