/*
 Sorry, I ran out of time and didn't fix tests to match the implementation,
 although it should be well-testable, and all that.
 I do understand the importance of testing and taking time for writing good tests,
 we can discuss it further during the review. Have a nice day!
 */
